...
export default function MsgFromUser({
  ...
  return (
    <div onContextMenu={(event) => { contextMenuOpen(event); open() }} className='w-[300px] p-[10px] mb-[10px] rounded-tl-[15px] rounded-tr-[15px] rounded-br-[15px] break-words inline-block bg-[#222222]'>
